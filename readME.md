...
4. 문제없이 로그인 했는지 확인하기![캡처2](images/캡처2.JPG)
...
4. articles/templates/articles/detail.html
   ...
   - 로그인 후 `detail`페이지 상태![캡처6](images/캡처6.JPG)
...
8. 결과창 : @login_reqired가 필요![캡처8](images/캡처8.JPG)
